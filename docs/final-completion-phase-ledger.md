...
| P111 | contract golden fixtures | golden fixture set | Promoted to Phase 111; contract artifact, schema validation, and regression hash manifest are locked; Phase 113-P252 identity/policy/resource/evidence/event/workflow/runtime/personal-dev/law-firm fixtures are included, including matter_os_profile through law_firm_e2e_freeze, for 154 total fixtures |
