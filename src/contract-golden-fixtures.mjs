...
export const DEFAULT_CONTRACT_GOLDEN_FIXTURES_INPUTS = {
  ...
  artifactPaths: {
    ...
    document_renderer_adapter: "artifacts/document-renderer-adapter/latest/document-renderer-adapter.json",
    worktree_manager_v2: "artifacts/worktree-manager-v2/latest/worktree-manager-v2.json",
    sandbox_policy_model: "artifacts/sandbox-policy-model/latest/sandbox-policy-model.json",
    docker_local_backend_selector: "artifacts/docker-local-backend-selector/latest/docker-local-backend-selector.json",
    secrets_broker_contract: "artifacts/secrets-broker/latest/secrets-broker-contract.json",
    runtime_artifact_capture: "artifacts/runtime-artifact-capture/latest/runtime-artifact-capture.json",
    runtime_log_normalization: "artifacts/runtime-log-normalization/latest/runtime-log-normalization.json",
    runtime_timeout_heartbeat: "artifacts/runtime-timeout-heartbeat/latest/runtime-timeout-heartbeat.json",
    runtime_control_commands: "artifacts/runtime-control-commands/latest/runtime-control-commands.json",
    runtime_api_dashboard: "artifacts/runtime-api-dashboard/latest/runtime-api-dashboard.json",
    runtime_freeze: "artifacts/runtime-freeze/latest/runtime-freeze.json",
    protected_file_gate: "artifacts/protected-file-gate/latest/protected-file-gate.json",
    canonical_test_runner: "artifacts/canonical-test-runner/latest/canonical-test-runner.json",
    ...
    personal_dev_pack_manifest: "artifacts/personal-dev-pack-manifest/latest/personal-dev-pack-manifest.json",
    law_firm_pack_manifest: "artifacts/law-firm-pack-manifest/latest/law-firm-pack-manifest.json",
    repo_profile_detector: "artifacts/repo-profile-detector/latest/repo-profile-detector.json",
    agent_instruction_registry: "artifacts/agent-instruction-registry/latest/agent-instruction-registry.json",
    issue_intake_adapter: "artifacts/issue-intake-adapter/latest/issue-intake-adapter.json",
    plan_request_contract: "artifacts/plan-request-contract/latest/plan-request-contract.json",
    plan_reconciliation: "artifacts/plan-reconciliation/latest/plan-reconciliation.json",
    scope_freeze_gate: "artifacts/scope-freeze-gate/latest/scope-freeze-gate.json",
    dev_lane_ledger: "artifacts/dev-lane-ledger/latest/dev-lane-ledger.json",
    implementation_patch_capture: "artifacts/implementation-patch-capture/latest/implementation-patch-capture.json",
    diff_review_gate: "artifacts/diff-review-gate/latest/diff-review-gate.json",
    canonical_test_matrix: "artifacts/canonical-test-matrix/latest/canonical-test-matrix.json",
    dev_protected_scan: "artifacts/dev-protected-scan/latest/dev-protected-scan.json",
    pr_draft_artifact: "artifacts/pr-draft-artifact/latest/pr-draft-artifact.json",
    release_note_artifact: "artifacts/release-note-artifact/latest/release-note-artifact.json",
    rollback_plan_artifact: "artifacts/rollback-plan-artifact/latest/rollback-plan-artifact.json",
    technical_debt_ledger: "artifacts/technical-debt-ledger/latest/technical-debt-ledger.json",
    personal_dev_dashboard_api: "artifacts/personal-dev-dashboard-api/latest/personal-dev-dashboard-api.json",
    personal_dev_e2e_freeze: "artifacts/personal-dev-e2e-freeze/latest/personal-dev-e2e-freeze.json",
    personal_dev_e2e_report: "artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-report.json",
    ...
    matter_os_profile: "artifacts/matter-os-profile/latest/matter-os-profile.json",
    matter_timeline: "artifacts/matter-timeline/latest/matter-timeline.json",
    matter_document_index: "artifacts/matter-document-index/latest/matter-document-index.json",
    matter_task_board: "artifacts/matter-task-board/latest/matter-task-board.json",
    matter_knowledge_graph: "artifacts/matter-knowledge-graph/latest/matter-knowledge-graph.json",
    matter_privilege_classifier: "artifacts/matter-privilege-classifier/latest/matter-privilege-classifier.json",
    matter_personal_data_detector: "artifacts/matter-personal-data-detector/latest/matter-personal-data-detector.json",
    legal_citation_verifier: "artifacts/legal-citation-verifier/latest/legal-citation-verifier.json",
    ldd_vdr_inventory: "artifacts/ldd-vdr-inventory/latest/ldd-vdr-inventory.json",
    ldd_document_classification: "artifacts/ldd-document-classification/latest/ldd-document-classification.json",
    ldd_extractor_selection: "artifacts/ldd-extractor-selection/latest/ldd-extractor-selection.json",
    ldd_fact_extraction: "artifacts/ldd-fact-extraction/latest/ldd-fact-extraction.json",
    ldd_issue_detection: "artifacts/ldd-issue-detection/latest/ldd-issue-detection.json",
    ...
    creative_document_e2e_report: "artifacts/creative-document-e2e-report/latest/creative-document-e2e-report.json",
    ingestion_e2e_report: "artifacts/ingestion-e2e-report/latest/ingestion-e2e-report.json",
    deployment_runbook: "artifacts/deployment-runbook/latest/deployment-runbook.json",
    operator_handbook: "artifacts/operator-handbook/latest/operator-handbook.json",
    release_candidate_report: "artifacts/release-candidate-report/latest/release-candidate-report.json",
    v1_freeze: "artifacts/v1-freeze/latest/v1-freeze.json",
...
const GOLDEN_FIXTURE_DEFINITIONS = [
  ...
  fixtureDefinition("document_renderer_adapter", "Document Renderer Adapter", "runtime", "document-renderer-adapter.schema.json"),
  fixtureDefinition("worktree_manager_v2", "Worktree Manager v2", "runtime", "worktree-manager-v2.schema.json"),
  fixtureDefinition("sandbox_policy_model", "Sandbox Policy Model", "runtime", "sandbox-policy-model.schema.json"),
  fixtureDefinition("docker_local_backend_selector", "Docker/local Backend Selector", "runtime", "docker-local-backend-selector.schema.json"),
  fixtureDefinition("secrets_broker_contract", "Secrets Broker Contract", "runtime", "secrets-broker-contract.schema.json"),
  fixtureDefinition("runtime_artifact_capture", "Runtime Artifact Capture", "runtime", "runtime-artifact-capture.schema.json"),
  fixtureDefinition("runtime_log_normalization", "Runtime Log Normalization", "runtime", "runtime-log-normalization.schema.json"),
  fixtureDefinition("runtime_timeout_heartbeat", "Runtime Timeout/Heartbeat", "runtime", "runtime-timeout-heartbeat.schema.json"),
  fixtureDefinition("runtime_control_commands", "Runtime Control Commands", "runtime", "runtime-control-commands.schema.json"),
  fixtureDefinition("runtime_api_dashboard", "Runtime API Dashboard", "api", "runtime-api-dashboard.schema.json"),
  fixtureDefinition("runtime_freeze", "Runtime Freeze", "runtime", "runtime-freeze.schema.json"),
  fixtureDefinition("protected_file_gate", "Protected File Gate", "gate_approval", "protected-file-gate.schema.json"),
  fixtureDefinition("canonical_test_runner", "Canonical Test Runner", "gate_approval", "canonical-test-runner.schema.json"),
  ...
  fixtureDefinition("personal_dev_pack_manifest", "Personal Dev Pack Manifest", "personal_dev", "personal-dev-pack-manifest.schema.json"),
  fixtureDefinition("law_firm_pack_manifest", "Law Firm Pack Manifest", "law_firm", "law-firm-pack-manifest.schema.json"),
  fixtureDefinition("repo_profile_detector", "Repo Profile Detector", "personal_dev", "repo-profile-detector.schema.json"),
  fixtureDefinition("agent_instruction_registry", "Agent Instruction Registry", "personal_dev", "agent-instruction-registry.schema.json"),
  fixtureDefinition("issue_intake_adapter", "Issue Intake Adapter", "personal_dev", "issue-intake-adapter.schema.json"),
  fixtureDefinition("plan_request_contract", "Plan Request Contract", "personal_dev", "plan-request-contract.schema.json"),
  fixtureDefinition("plan_reconciliation", "Plan Reconciliation", "personal_dev", "plan-reconciliation.schema.json"),
  fixtureDefinition("scope_freeze_gate", "Scope Freeze Gate", "personal_dev", "scope-freeze-gate.schema.json"),
  fixtureDefinition("dev_lane_ledger", "Dev Lane Ledger", "personal_dev", "dev-lane-ledger.schema.json"),
  fixtureDefinition("implementation_patch_capture", "Implementation Patch Capture", "personal_dev", "implementation-patch-capture.schema.json"),
  fixtureDefinition("diff_review_gate", "Diff Review Gate", "personal_dev", "diff-review-gate.schema.json"),
  fixtureDefinition("canonical_test_matrix", "Canonical Test Matrix", "personal_dev", "canonical-test-matrix.schema.json"),
  fixtureDefinition("dev_protected_scan", "Dev Protected Scan", "personal_dev", "dev-protected-scan.schema.json"),
  fixtureDefinition("pr_draft_artifact", "PR Draft Artifact", "personal_dev", "pr-draft-artifact.schema.json"),
  fixtureDefinition("release_note_artifact", "Release Note Artifact", "personal_dev", "release-note-artifact.schema.json"),
  fixtureDefinition("rollback_plan_artifact", "Rollback Plan Artifact", "personal_dev", "rollback-plan-artifact.schema.json"),
  fixtureDefinition("technical_debt_ledger", "Technical Debt Ledger", "personal_dev", "technical-debt-ledger.schema.json"),
  fixtureDefinition("personal_dev_dashboard_api", "Personal Dev Dashboard API", "personal_dev", "personal-dev-dashboard-api.schema.json"),
  fixtureDefinition("personal_dev_e2e_freeze", "Personal Dev E2E Freeze", "personal_dev", "personal-dev-e2e-freeze.schema.json"),
  fixtureDefinition("personal_dev_e2e_report", "Personal Dev E2E Report", "personal_dev", "personal-dev-e2e-report.schema.json"),
  fixtureDefinition("matter_os_profile", "Matter OS Profile", "law_firm", "matter-os-profile.schema.json"),
  fixtureDefinition("matter_timeline", "Matter Timeline", "law_firm", "matter-timeline.schema.json"),
  fixtureDefinition("matter_document_index", "Matter Document Index", "law_firm", "matter-document-index.schema.json"),
  fixtureDefinition("matter_task_board", "Matter Task Board", "law_firm", "matter-task-board.schema.json"),
  fixtureDefinition("matter_knowledge_graph", "Matter Knowledge Graph", "law_firm", "matter-knowledge-graph.schema.json"),
  fixtureDefinition("matter_privilege_classifier", "Matter Privilege Classifier", "law_firm", "matter-privilege-classifier.schema.json"),
  fixtureDefinition("matter_personal_data_detector", "Matter Personal Data Detector", "law_firm", "matter-personal-data-detector.schema.json"),
  fixtureDefinition("legal_citation_verifier", "Legal Citation Verifier", "law_firm", "legal-citation-verifier.schema.json"),
  fixtureDefinition("ldd_vdr_inventory", "LDD VDR Inventory", "law_firm", "ldd-vdr-inventory.schema.json"),
  fixtureDefinition("ldd_document_classification", "LDD Document Classification", "law_firm", "ldd-document-classification.schema.json"),
  fixtureDefinition("ldd_extractor_selection", "LDD Extractor Selection", "law_firm", "ldd-extractor-selection.schema.json"),
  fixtureDefinition("ldd_fact_extraction", "LDD Fact Extraction", "law_firm", "ldd-fact-extraction.schema.json"),
  fixtureDefinition("ldd_issue_detection", "LDD Issue Detection", "law_firm", "ldd-issue-detection.schema.json"),
  ...
  fixtureDefinition("creative_document_e2e_report", "Creative Document E2E Report", "creative_document", "creative-document-e2e-report.schema.json"),
  fixtureDefinition("ingestion_e2e_report", "Ingestion E2E Report", "resource_evidence", "ingestion-e2e-report.schema.json"),
  fixtureDefinition("deployment_runbook", "Deployment Runbook", "deployment", "deployment-runbook.schema.json"),
  fixtureDefinition("operator_handbook", "Operator Handbook", "operator", "operator-handbook.schema.json"),
  fixtureDefinition("release_candidate_report", "Release Candidate Report", "release", "release-candidate-report.schema.json"),
  fixtureDefinition("v1_freeze", "Hermes Harness v1.0 Freeze", "release", "v1-freeze.schema.json"),
