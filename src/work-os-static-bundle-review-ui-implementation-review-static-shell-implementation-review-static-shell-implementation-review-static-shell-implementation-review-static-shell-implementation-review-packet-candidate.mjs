...
import {
  ALL_FALSE_FLAGS as P58800_FALSE_FLAGS,
  buildWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackage,
} from "./work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-handoff-package.mjs";

export const DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_PACKET_OUT_DIR = "artifacts/work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate/latest";
export const DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_PACKET_INPUTS = {
  schemaPath: "schemas/work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate.schema.json",
  packagePath: "package.json",
  roadmapDocPath: "docs/hermes-roadmap-p58801-p59200.md",
  architectureDocPath: "docs/architecture.md",
  sourceWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackagePath: "artifacts/work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-handoff-package/latest/work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-handoff-package.json",
};

const COMMAND_NAME = "platform:work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate";
const SCHEMA_VERSION = "work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate.v1";
const CAPABILITY_ID = "platform.work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_packet_candidate";
const PROGRAM_RANGE = "P58801-P59200";
const SOURCE_PROGRAM_RANGE = "P58401-P58800";
const READY_STATUS = "ready_for_work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_packet_candidate";
const BLOCK_PENDING_STATUS = "valid_block_work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_packet_candidate_pending";
const BLOCKED_STATUS = "blocked_work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_packet_candidate";
...
export const ALL_FALSE_FLAGS = [...new Set([...WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_FALSE_FLAGS, ...P58800_FALSE_FLAGS])];

export async function runWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidate(options = {}) {
  const result = await buildWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidate(options);
  if (options.check && !result.validation.valid) {
    const error = new Error(`Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate failed with ${result.validation.errors.length} error(s).`);
    error.validation = result.validation;
    throw error;
  }
  if (!options.check && options.write !== false) await writeWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidate(result, result.output_dir);
  return result;
}

export async function buildWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidate(options = {}) {
  const generatedAt = new Date(options.runAt ?? new Date()).toISOString();
  const outputDir = path.resolve(options.outDir ?? DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_PACKET_OUT_DIR);
  const inputs = normalizeInputs(options);
  const schema = await readJsonSource(inputs.schema_path);
  const packageJson = await readJsonSource(inputs.package_path);
  const roadmapDoc = await readTextSource(inputs.roadmap_doc_path);
  const architectureDoc = await readTextSource(inputs.architecture_doc_path);
  const source = Object.prototype.hasOwnProperty.call(options, "workOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackage")
    ? normalizeInlineJsonSource("inline.work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package", options.workOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackage)
    : await readJsonOrBuildP58800(inputs.source_work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package_path, generatedAt);
  ...
  const result = {
    ...
    inputs,
    source_refs: {
      work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package_path: source.path,
      source_commit_ref: commitRef || null,
    },
    source_work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package_summary: source.data?.summary ?? null,
    ...
    p58800_source_binding_rows: sourceRows,
    ...
    p59200_clean_checkpoint_rows: checkpointRows,
  ...
  const schemaErrors = schema.available
    ? validateAgainstSchema(result, schema.data, {}, "work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_packet_candidate")
...
export async function writeWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidate(result, outDir = result.output_dir) {
  await mkdir(outDir, { recursive: true });
  await writeJson(path.join(outDir, "work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate.json"), serializableResult(result));
  await writeJson(path.join(outDir, "p58800-source-binding-rows.json"), collectionEnvelope("p58800-source-binding-rows.v1", "p58800_source_binding_rows", result.p58800_source_binding_rows, result.generated_at));
  ...
  await writeJson(path.join(outDir, "p59200-clean-checkpoint-rows.json"), collectionEnvelope("p59200-clean-checkpoint-rows.v1", "p59200_clean_checkpoint_rows", result.p59200_clean_checkpoint_rows, result.generated_at));
...
export async function runWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidateCli(argv = process.argv.slice(2)) {
  const args = parseArgs(argv);
  if (args.help) {
    printHelp();
    return null;
  }
  const result = await runWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewPacketCandidate(args);
  console.log(`Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate ${args.check ? "validated" : "written"} at ${result.output_dir}`);
  console.log(`Status: ${result.summary.work_os_static_bundle_review_ui_implementation_review_status}`);
  console.log(`Program: ${result.program_range}`);
  console.log(`P58800 ready for implementation review packet: ${result.summary.source_p58800_ready_for_implementation_review_packet}`);
...
function buildSourceState(source) {
  ...
  const boundary = source.data?.work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package_boundary ?? {};
  return {
    available: source.available === true,
    programRangeOk: source.data?.program_range === SOURCE_PROGRAM_RANGE,
    validationValid: source.data?.validation?.valid === true,
    sourceReady: summary.ready_for_p58801_handoff === true,
    status: summary.work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package_status ?? "missing",
    p58800ContractReady: boundary.p58800_contract_ready === true,
    ...
    boundaryClosed: P58800_FALSE_FLAGS.every((flag) => boundary[flag] === false),
  };
}
...
function buildPhaseRows(roadmapText, generatedAt) {
  return PHASE_SPECS.map(([range, label, outputRef]) => row({
    ...
    evidence_ref: "docs/hermes-roadmap-p58801-p59200.md",
...
function buildSourceRows({ source, sourceState, commitRef, generatedAt }) {
  return [
    ["artifact_available", "P58800 implementation static shell handoff package source is available", sourceState.available],
    ["program_range", "P58800 source program range is P58401-P58800", sourceState.programRangeOk],
    ["validation_valid", "P58800 source validation is valid", sourceState.validationValid],
    ["implementation_review_packet_open", "P58800 opened implementation review packet metadata", sourceState.sourceReady],
    ["p58800_contract_ready", "P58800 source contract is ready", sourceState.p58800ContractReady],
    ["handoff_package_visible", "P58800 implementation static shell handoff package rows are visible", sourceState.handoffPackageVisible],
    ["manifest_visible", "P58800 implementation file manifest rows are visible", sourceState.manifestVisible],
    ["fixture_smoke_visible", "P58800 fixture/smoke plan rows are visible", sourceState.fixtureSmokeVisible],
    ["reviewer_note_visible", "P58800 reviewer handoff note rows are visible", sourceState.reviewerNoteVisible],
    ["no_implementation_closed", "P58800 no-implementation boundary is closed", sourceState.noImplementationClosed],
    ["commit_ref_present", "Current commit ref is present for implementation review packet candidate", Boolean(commitRef)],
    ["source_blocker_visible", "P58800 source blocker is visible when implementation review packet is closed", sourceState.available],
  ].map(([id, label, observed]) => row({
    row_id: `source_binding.${id}`,
    category: "p58800_source_binding",
    label,
    observed,
...
function buildImplementationReviewPacketCandidateRows({ source, generatedAt }) {
  const handoffRows = source.data?.handoff_package_candidate_rows ?? [];
  return handoffRows.map((handoff) => {
    const requestId = handoff.shell_section_id ?? handoff.request_id ?? handoff.row_id;
    return row({
    row_id: `implementation_review_packet_candidate.${requestId}`,
    category: "implementation_review_packet_candidate",
    label: `Implementation review packet candidate for ${requestId}`,
    observed: handoff.current_verdict === "pass" && handoff.handoff_metadata_only === true,
    evidence_ref: handoff.row_id,
    request_id: requestId,
    shell_section_id: requestId,
    implementation_review_packet_ref: `work_os.static_bundle_review.implementation_review_static_shell.${requestId}.review_packet.candidate`,
    implementation_review_static_shell_implementation_handoff_package_ref: handoff.row_id,
    component_path_ref: handoff.candidate_path_hint,
    test_path_ref: `test/ui/work-os/implementation-review-static-shell/${safePathSegment(requestId)}.test.mjs`,
    style_path_ref: handoff.design_token_hook,
    component_name: handoff.component_slot_hint,
    route_path: handoff.route_hint,
    api_projection_ref: handoff.api_projection_ref,
    component_class_hook: handoff.component_class_hook,
...
function buildImplementationReviewEvidenceSummaryRows({ source, packetRows, generatedAt }) {
  ...
  return packetRows.map((packet) => {
    const handoff = handoffRows.find((item) => (item.shell_section_id ?? item.request_id) === packet.request_id);
    const manifest = manifestRows.find((item) => (item.shell_section_id ?? item.request_id) === packet.request_id);
    const smoke = smokeRows.find((item) => (item.shell_section_id ?? item.request_id) === packet.request_id);
    const reviewer = reviewerRows.find((item) => (item.shell_section_id ?? item.request_id) === packet.request_id);
    return row({
...
function buildWiringRows({ packageJson, roadmapDoc, architectureDoc, generatedAt }) {
  return [
    ...
    ["validate_chain", "Validate chain includes P59200 check", packageJson.text.includes(`${COMMAND_NAME} -- --check`), "package.json"],
    ["schema_file", "Schema file is configured", packageJson.available, "schemas/work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate.schema.json"],
    ["roadmap_doc", "Roadmap documents all P58801-P59200 slices", PHASE_SPECS.every(([range]) => roadmapDoc.text.includes(range)), "docs/hermes-roadmap-p58801-p59200.md"],
    ["architecture_doc", "Architecture doc references P58801-P59200", architectureDoc.text.includes("P58801-P59200 Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate"), "docs/architecture.md"],
...
function buildCheckpointRows(context) {
  ...
  return [
    ["source_ready", "P58800 source is ready for implementation review packet handoff", context.sourceState.sourceReady],
    ...
    ["p59200_review_packet_handoff", "P59200 review packet handoff opens only as metadata", ready],
  ].map(([id, label, observed]) => row({
    row_id: `p59200_checkpoint.${id}`,
    category: "p59200_clean_checkpoint",
    label,
    observed,
    evidence_ref: "p59200_clean_checkpoint_rows",
    generated_at: context.generatedAt,
  }));
}

function buildBoundary(context) {
  const p59200ContractReady = allPass(context.phaseRows)
    ...
    && allPass(context.boundaryRows)
    && allPass(context.wiringRows)
    && visibleOrPassed(context.checkpointRows, "p59200_checkpoint.review_completion_blocked")
    && visibleOrPassed(context.checkpointRows, "p59200_checkpoint.review_receipt_create_blocked")
    && visibleOrPassed(context.checkpointRows, "p59200_checkpoint.file_apply_blocked");
  const ready = context.sourceState.sourceReady
    && context.sourceState.validationValid
    && context.sourceState.boundaryClosed
    && p59200ContractReady;
  return {
    p59200_contract_ready: p59200ContractReady,
    ready_for_work_os_static_bundle_review_ui_implementation_review_request_handoff: ready,
    source_p58800_ready_for_implementation_review_packet: context.sourceState.sourceReady,
...
function buildValidationItems(context) {
  return [
    validationItem("roadmap.phase_coverage", "roadmap", allPass(context.phaseRows), "P58801-P59200 phase rows are incomplete"),
    validationItem("source.visible", "source", visibleOrPassed(context.sourceRows, "source_binding.source_blocker_visible"), "P58800 source state is not visible"),
    ...
    validationItem("wiring.complete", "wiring", allPass(context.wiringRows), "P58801-P59200 wiring is incomplete"),
    ...
    validationItem("checkpoint.review_completion_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p59200_checkpoint.review_completion_blocked"), "P59200 review completion blocker checkpoint is not visible"),
    validationItem("checkpoint.review_receipt_create_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p59200_checkpoint.review_receipt_create_blocked"), "P59200 review receipt blocker checkpoint is not visible"),
    validationItem("checkpoint.file_apply_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p59200_checkpoint.file_apply_blocked"), "P59200 file apply blocker checkpoint is not visible"),
  ];
}

function buildContract(generatedAt) {
  return {
    contract_id: "work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_packet_candidate.contract.v1",
    generated_at: generatedAt,
    source_p58800_required_or_rebuilt: true,
    ...
    p59200_is_not_review_receipt_review_completion_finding_resolution_reviewer_dispatch_claude_execution_human_adjudication_file_apply_approval_production_or_enterprise_trust: true,
...
function buildSummary({ boundary, validation }) {
  const status = validation.valid && boundary.ready_for_work_os_static_bundle_review_ui_implementation_review_request_handoff
    ? READY_STATUS
    : validation.valid && boundary.p59200_contract_ready
      ? BLOCK_PENDING_STATUS
      : BLOCKED_STATUS;
  return {
    work_os_static_bundle_review_ui_implementation_review_status: status,
    source_p58800_ready_for_implementation_review_packet: boundary.source_p58800_ready_for_implementation_review_packet,
...
function renderMarkdown(result) {
  return [
    "# Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate",
    "",
    `Status: ${result.summary.work_os_static_bundle_review_ui_implementation_review_status}`,
    `Program: ${result.program_range}`,
    `P58800 ready for implementation review packet: ${result.summary.source_p58800_ready_for_implementation_review_packet}`,
...
<head>
  ...
  <title>Hermes Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate</title>
  <style>
...
<body>
  <main>
    <h1>Hermes Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate</h1>
...
async function readJsonOrBuildP58800(filePath, generatedAt) {
  const source = await readJsonSource(filePath);
  if (source.available) return source;
  const built = await buildWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackage({ runAt: generatedAt, write: false });
  return normalizeInlineJsonSource("built.work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package", built);
}
...
function normalizeInputs(options) {
  const defaults = DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_STATIC_SHELL_IMPLEMENTATION_REVIEW_PACKET_INPUTS;
  ...
  return {
    ...
    source_work_os_static_bundle_review_ui_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_review_static_shell_implementation_handoff_package_path: path.resolve(repoRoot, options.sourceWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackagePath ?? defaults.sourceWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackagePath),
  };
}
...
function parseArgs(argv) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (arg === "--check") {
      ...
      args.sourceWorkOsStaticBundleReviewUiImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationReviewStaticShellImplementationHandoffPackagePath = argv[++index];
...
function printHelp() {
  console.log(`Usage: node scripts/work-os-static-bundle-review-ui-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-static-shell-implementation-review-packet-candidate.mjs [--check] [--out-dir DIR] [--source FILE] [--commit-ref SHA]

Validates or writes the Hermes P58801-P59200 Work OS Static Bundle Review UI Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Static Shell Implementation Review Packet Candidate.
`);
}
