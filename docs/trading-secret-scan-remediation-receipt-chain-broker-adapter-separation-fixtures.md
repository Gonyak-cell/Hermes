...
P447 consumes P446 secret scan remediation receipt-chain signoff closeout readiness
and records broker adapter separation fixtures for the post-closeout safety
...
- Source: P446 `trading:secret-scan-remediation-receipt-chain-signoff-closeout-fixtures`.
- Output: `artifacts/trading-secret-scan-remediation-receipt-chain-broker-adapter-separation-fixtures/latest`.
- Workflow: `workflow.trading.secret_scan_remediation_receipt_chain_broker_adapter_separation_fixtures.v1`.
- Capability: `trading.secret_scan_remediation_receipt_chain_broker_adapter_separation_fixtures`.
...
```sh
npm run trading:secret-scan-remediation-receipt-chain-broker-adapter-separation-fixtures -- --check
```
