...
function buildReproducibilityGateRows({ replayHandoffCloseout, packageJson, platformOpsLedger, reproducibilityCheckRows, releaseChainBridgeRows }) {
  ...
  const rows = [
    ...
    gateRow("p357_next_phase_reserved", "P357-P360 remains reserved for reproducibility evidence and closeout checks.", ledgerText.includes("P357-P360") && ledgerText.includes("reproducibility")),
  ];
