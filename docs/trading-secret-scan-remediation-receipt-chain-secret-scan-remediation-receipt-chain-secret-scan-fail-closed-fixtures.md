...
P479 consumes P478 secret-scan attention readiness and the P300 Secrets Scan
...
- Source: P478 `trading:secret-scan-remediation-receipt-chain-secret-scan-remediation-receipt-chain-secret-scan-attention-fixtures`.
- Source: P300 `security:secrets-scan-gate`.
- Output: `artifacts/trading-secret-scan-remediation-receipt-chain-secret-scan-remediation-receipt-chain-secret-scan-fail-closed-fixtures/latest`.
- Workflow: `workflow.trading.secret_scan_remediation_receipt_chain_secret_scan_remediation_receipt_chain_secret_scan_fail_closed_fixtures.v1`.
- Capability: `trading.secret_scan_remediation_receipt_chain_secret_scan_remediation_receipt_chain_secret_scan_fail_closed_fixtures`.
...
```sh
npm run trading:secret-scan-remediation-receipt-chain-secret-scan-remediation-receipt-chain-secret-scan-fail-closed-fixtures -- --check
```
