...
function buildFreezeGateRows({ freezeClosureRows, packageJson, platformOpsLedger, provenanceFreezePreflight }) {
  ...
  const rows = [
    ...
    gateRow("p351_next_phase_reserved", "P351 starts Mac/Windows replay notes and P352 owns lockfile policy.", ledgerText.includes("P351: `platform:mac-windows-replay-notes`") && ledgerText.includes("P352: `platform:lockfile-policy`")),
  ];
