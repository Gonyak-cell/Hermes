...
export const DEFAULT_CONTROL_PLANE_LOOP_STEPS = [
  ...
  step("dashboard_pre_health", "Dashboard Pre-Health", "dashboard", ["node", "scripts/review-dashboard.mjs", "--no-human-review-agenda", "--no-human-review-agenda-intake"], ["artifacts/dashboard/latest/review-dashboard.json"]),
