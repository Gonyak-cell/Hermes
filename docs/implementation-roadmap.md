...
| P267-P276 | Connector and Ingestion Layer | Connector Contract v2를 기준으로 Outlook email, KakaoTalk import boundary, OneDrive/local folder, GitHub, VDR, Plaud, ERP, future Slack/Teams connector를 adapter 방식으로 확장한다. |
