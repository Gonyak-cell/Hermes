...
import {
  ALL_FALSE_FLAGS as P40400_FALSE_FLAGS,
  buildWorkOsStaticBundleReviewUiImplementationReviewApiReadModel,
} from "./work-os-static-bundle-review-ui-implementation-review-api-read-model.mjs";

export const DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_UI_OUT_DIR = "artifacts/work-os-static-bundle-review-ui-implementation-review-static-ui-adapter/latest";
export const DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_UI_INPUTS = {
  schemaPath: "schemas/work-os-static-bundle-review-ui-implementation-review-static-ui-adapter.schema.json",
  packagePath: "package.json",
  roadmapDocPath: "docs/hermes-roadmap-p40401-p40800.md",
  architectureDocPath: "docs/architecture.md",
  sourceWorkOsStaticBundleReviewUiImplementationReviewApiReadModelPath: "artifacts/work-os-static-bundle-review-ui-implementation-review-api-read-model/latest/work-os-static-bundle-review-ui-implementation-review-api-read-model.json",
};

const COMMAND_NAME = "platform:work-os-static-bundle-review-ui-implementation-review-static-ui-adapter";
const SCHEMA_VERSION = "work-os-static-bundle-review-ui-implementation-review-static-ui-adapter.v1";
const CAPABILITY_ID = "platform.work_os_static_bundle_review_ui_implementation_review_static_ui_adapter";
const PROGRAM_RANGE = "P40401-P40800";
const SOURCE_PROGRAM_RANGE = "P40001-P40400";
const READY_STATUS = "ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_adapter";
const BLOCK_PENDING_STATUS = "valid_block_work_os_static_bundle_review_ui_implementation_review_static_ui_adapter_pending";
const BLOCKED_STATUS = "blocked_work_os_static_bundle_review_ui_implementation_review_static_ui_adapter";
...
export const WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_UI_FALSE_FLAGS = [
  "work_os_static_bundle_review_ui_implementation_review_static_ui_live_mount_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_runtime_fetch_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_event_handler_mutation_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_form_submit_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_state_persist_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_route_navigation_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_action_button_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_status_edit_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_write_api_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_live_browser_required_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_generated_file_write_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_asset_pipeline_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_receipt_accept_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_receipt_create_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_review_completion_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_reviewer_dispatch_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_claude_review_execution_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_human_adjudication_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_finding_resolution_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_runtime_execution_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_write_action_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_protected_action_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_connector_write_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_deployment_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_final_approval_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_production_pass_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_enterprise_trust_claim_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_secret_read_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_human_gate_bypass_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_independent_review_bypass_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_static_ui_final_automated_approval_allowed_now",
];

export const ALL_FALSE_FLAGS = [...new Set([...WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_UI_FALSE_FLAGS, ...P40400_FALSE_FLAGS])];

export async function runWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapter(options = {}) {
  const result = await buildWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapter(options);
  if (options.check && !result.validation.valid) {
    const error = new Error(`Work OS Static Bundle Review UI Implementation Review Static UI Adapter failed with ${result.validation.errors.length} error(s).`);
    error.validation = result.validation;
    throw error;
  }
  if (!options.check && options.write !== false) await writeWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapter(result, result.output_dir);
  return result;
}

export async function buildWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapter(options = {}) {
  const generatedAt = new Date(options.runAt ?? new Date()).toISOString();
  const outputDir = path.resolve(options.outDir ?? DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_UI_OUT_DIR);
  const inputs = normalizeInputs(options);
  const schema = await readJsonSource(inputs.schema_path);
  const packageJson = await readJsonSource(inputs.package_path);
  const roadmapDoc = await readTextSource(inputs.roadmap_doc_path);
  const architectureDoc = await readTextSource(inputs.architecture_doc_path);
  const source = Object.prototype.hasOwnProperty.call(options, "workOsStaticBundleReviewUiImplementationReviewApiReadModel")
    ? normalizeInlineJsonSource("inline.work_os_static_bundle_review_ui_implementation_review_api_read_model", options.workOsStaticBundleReviewUiImplementationReviewApiReadModel)
    : await readJsonOrBuildP40400(inputs.source_work_os_static_bundle_review_ui_implementation_review_api_read_model_path, generatedAt);
  ...
  const result = {
    ...
    inputs,
    source_refs: {
      work_os_static_bundle_review_ui_implementation_review_api_read_model_path: source.path,
      source_commit_ref: commitRef || null,
    },
    source_work_os_static_bundle_review_ui_implementation_review_api_summary: source.data?.summary ?? null,
    work_os_static_bundle_review_ui_implementation_review_static_ui_contract: buildContract(generatedAt),
    work_os_static_bundle_review_ui_implementation_review_static_ui_phase_rows: phaseRows,
    p40400_source_binding_rows: sourceRows,
    ...
    work_os_static_bundle_review_ui_implementation_review_static_ui_wiring_rows: wiringRows,
    p40800_clean_checkpoint_rows: checkpointRows,
    work_os_static_bundle_review_ui_implementation_review_static_ui_boundary: boundary,
    work_os_static_bundle_review_ui_implementation_review_static_ui_validation_items: validationItems,
    validation: preliminaryValidation,
    summary: buildSummary({ boundary, validation: preliminaryValidation }),
  };

  const schemaErrors = schema.available
    ? validateAgainstSchema(result, schema.data, {}, "work_os_static_bundle_review_ui_implementation_review_static_ui_adapter")
    : [{ path: "schema", message: schema.error ?? "Schema unavailable" }];
  const schemaValidationItems = schemaErrors.map((error, index) => validationItem(`schema.${index}`, "schema_validation", false, error.message));
  result.work_os_static_bundle_review_ui_implementation_review_static_ui_validation_items = [...validationItems, ...schemaValidationItems];
  result.validation = summarizeValidation(result.work_os_static_bundle_review_ui_implementation_review_static_ui_validation_items);
  result.summary = buildSummary({ boundary, validation: result.validation });
  return { ...result, markdown: renderMarkdown(result), html: renderHtml(result) };
}

export async function writeWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapter(result, outDir = result.output_dir) {
  await mkdir(outDir, { recursive: true });
  await writeJson(path.join(outDir, "work-os-static-bundle-review-ui-implementation-review-static-ui-adapter.json"), serializableResult(result));
  await writeJson(path.join(outDir, "p40400-source-binding-rows.json"), collectionEnvelope("p40400-source-binding-rows.v1", "p40400_source_binding_rows", result.p40400_source_binding_rows, result.generated_at));
  ...
  await writeJson(path.join(outDir, "work-os-static-bundle-review-static-ui-wiring-rows.json"), collectionEnvelope("work-os-static-bundle-review-static-ui-wiring-rows.v1", "work_os_static_bundle_review_ui_implementation_review_static_ui_wiring_rows", result.work_os_static_bundle_review_ui_implementation_review_static_ui_wiring_rows, result.generated_at));
  await writeJson(path.join(outDir, "p40800-clean-checkpoint-rows.json"), collectionEnvelope("p40800-clean-checkpoint-rows.v1", "p40800_clean_checkpoint_rows", result.p40800_clean_checkpoint_rows, result.generated_at));
  await writeJson(path.join(outDir, "work-os-static-bundle-review-static-ui-boundary.json"), result.work_os_static_bundle_review_ui_implementation_review_static_ui_boundary);
  await writeFile(path.join(outDir, "summary.md"), result.markdown, "utf8");
  await writeFile(path.join(outDir, "index.html"), result.html, "utf8");
}

export async function runWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapterCli(argv = process.argv.slice(2)) {
  const args = parseArgs(argv);
  if (args.help) {
    printHelp();
    return null;
  }
  const result = await runWorkOsStaticBundleReviewUiImplementationReviewStaticUiAdapter(args);
  console.log(`Work OS Static Bundle Review UI Implementation Review Static UI Adapter ${args.check ? "validated" : "written"} at ${result.output_dir}`);
  console.log(`Status: ${result.summary.work_os_static_bundle_review_ui_implementation_review_static_ui_status}`);
  console.log(`Program: ${result.program_range}`);
  console.log(`P40400 ready for static review UI: ${result.summary.source_p40400_ready_for_static_review_ui}`);
  ...
  console.log(`Ready for static review UI handoff: ${result.summary.ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_handoff}`);
  console.log(`Live mount allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_static_ui_live_mount_allowed_now}`);
  console.log(`Receipt accept allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_static_ui_receipt_accept_allowed_now}`);
...
function buildSourceState(source) {
  ...
  const boundary = source.data?.work_os_static_bundle_review_ui_implementation_review_api_boundary ?? {};
  return {
    available: source.available === true,
    programRangeOk: source.data?.program_range === SOURCE_PROGRAM_RANGE,
    validationValid: source.data?.validation?.valid === true,
    sourceReady: summary.ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff === true,
    status: summary.work_os_static_bundle_review_ui_implementation_review_api_status ?? "missing",
    p40400ContractReady: boundary.p40400_contract_ready === true,
    ...
    wiringVisible: boundary.work_os_static_bundle_review_ui_implementation_review_api_wiring_complete_now === true,
    boundaryClosed: P40400_FALSE_FLAGS.every((flag) => boundary[flag] === false),
  };
}
...
function buildPhaseRows(roadmapText, generatedAt) {
  return PHASE_SPECS.map(([range, label, outputRef]) => row({
    ...
    evidence_ref: "docs/hermes-roadmap-p40401-p40800.md",
...
function buildSourceRows({ source, sourceState, commitRef, generatedAt }) {
  return [
    ["artifact_available", "P40400 review API read model source is available", sourceState.available],
    ["program_range", "P40400 source program range is P40001-P40400", sourceState.programRangeOk],
    ["validation_valid", "P40400 source validation is valid", sourceState.validationValid],
    ["static_review_ui_handoff_open", "P40400 opened static review UI handoff", sourceState.sourceReady],
    ["p40400_contract_ready", "P40400 source contract is ready", sourceState.p40400ContractReady],
    ["api_response_visible", "P40400 review API response rows are visible", sourceState.apiVisible],
    ["ui_fixture_visible", "P40400 review UI fixtures are visible", sourceState.fixtureVisible],
    ["route_contract_visible", "P40400 review route contracts are visible", sourceState.routeVisible],
    ["payload_shape_visible", "P40400 implementation review read-only payload shape rows are visible", sourceState.payloadVisible],
    ["no_receipt_accept_api_write_closed", "P40400 no mutation/review execution boundary is closed", sourceState.noReceiptAcceptApiWriteClosed],
    ["api_wiring_visible", "P40400 review API wiring is visible", sourceState.wiringVisible],
    ["commit_ref_present", "Current commit ref is present for static review UI adapter", Boolean(commitRef)],
    ["source_blocker_visible", "P40400 source blocker is visible when static review UI adapter is closed", sourceState.available],
  ].map(([id, label, observed]) => row({
    row_id: `source_binding.${id}`,
    category: "p40400_source_binding",
    label,
    observed,
...
function buildNoLiveUiReceiptAcceptBoundaryRows(generatedAt) {
  const stateRows = [
    ...
    label,
    observed,
    evidence_ref: "work_os_static_bundle_review_ui_implementation_review_static_ui_boundary",
    generated_at: generatedAt,
  }));
...
function buildWiringRows({ packageJson, roadmapDoc, architectureDoc, generatedAt }) {
  return [
    ...
    ["validate_chain", "Validate chain includes P40800 check", packageJson.text.includes(`${COMMAND_NAME} -- --check`), "package.json"],
    ["schema_file", "Schema file is configured", packageJson.available, "schemas/work-os-static-bundle-review-ui-implementation-review-static-ui-adapter.schema.json"],
    ["roadmap_doc", "Roadmap documents all P40401-P40800 slices", PHASE_SPECS.every(([range]) => roadmapDoc.text.includes(range)), "docs/hermes-roadmap-p40401-p40800.md"],
    ["architecture_doc", "Architecture doc references P40401-P40800", architectureDoc.text.includes("P40401-P40800 Work OS Static Bundle Review UI Implementation Review Static UI Adapter"), "docs/architecture.md"],
  ].map(([id, label, observed, evidenceRef]) => row({
    row_id: `work_os_static_bundle_review_ui_implementation_review_static_ui_wiring.${id}`,
    category: "work_os_static_bundle_review_ui_implementation_review_static_ui_wiring",
    label,
    observed,
...
function buildCheckpointRows(context) {
  ...
  return [
    ["source_ready", "P40400 source is ready for static review UI adapter handoff", context.sourceState.sourceReady],
    ...
    row_id: `p40800_checkpoint.${id}`,
    category: "p40800_clean_checkpoint",
    label,
    observed,
    evidence_ref: "p40800_clean_checkpoint_rows",
    generated_at: context.generatedAt,
  }));
}

function buildBoundary(context) {
  const p40800ContractReady = allPass(context.phaseRows)
    ...
    && allPass(context.boundaryRows)
    && allPass(context.wiringRows)
    && visibleOrPassed(context.checkpointRows, "p40800_checkpoint.live_mount_blocked")
    && visibleOrPassed(context.checkpointRows, "p40800_checkpoint.receipt_accept_blocked");
  const ready = context.sourceState.sourceReady
    && context.sourceState.validationValid
    && context.sourceState.boundaryClosed
    && p40800ContractReady;
  return {
    p40800_contract_ready: p40800ContractReady,
    ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_handoff: ready,
    source_p40400_ready_for_static_review_ui: context.sourceState.sourceReady,
    ...
    work_os_static_bundle_review_ui_implementation_review_static_ui_wiring_complete_now: allPass(context.wiringRows),
...
function buildValidationItems(context) {
  return [
    validationItem("roadmap.phase_coverage", "roadmap", allPass(context.phaseRows), "P40401-P40800 phase rows are incomplete"),
    validationItem("source.visible", "source", visibleOrPassed(context.sourceRows, "source_binding.source_blocker_visible"), "P40400 source state is not visible"),
    ...
    validationItem("wiring.complete", "wiring", allPass(context.wiringRows), "P40401-P40800 wiring is incomplete"),
    ...
    validationItem("checkpoint.live_mount_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p40800_checkpoint.live_mount_blocked"), "P40800 live mount blocker checkpoint is not visible"),
    validationItem("checkpoint.receipt_accept_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p40800_checkpoint.receipt_accept_blocked"), "P40800 receipt accept blocker checkpoint is not visible"),
  ];
}

function buildContract(generatedAt) {
  return {
    contract_id: "work_os_static_bundle_review_ui_implementation_review_static_ui_adapter.contract.v1",
    generated_at: generatedAt,
    source_p40400_required_or_rebuilt: true,
    ...
    p40800_is_not_live_ui_mount_runtime_fetch_event_mutation_form_submit_state_persist_receipt_accept_reviewer_dispatch_execution_write_approval_production_or_enterprise_trust: true,
    protected_authority: "closed",
  };
}

function buildSummary({ boundary, validation }) {
  const status = validation.valid && boundary.ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_handoff
    ? READY_STATUS
    : validation.valid && boundary.p40800_contract_ready
      ? BLOCK_PENDING_STATUS
      : BLOCKED_STATUS;
  return {
    work_os_static_bundle_review_ui_implementation_review_static_ui_status: status,
    source_p40400_ready_for_static_review_ui: boundary.source_p40400_ready_for_static_review_ui,
    ...
    ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_handoff: validation.valid && boundary.ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_handoff,
    work_os_static_bundle_review_ui_implementation_review_static_ui_live_mount_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_runtime_fetch_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_event_handler_mutation_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_form_submit_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_state_persist_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_route_navigation_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_action_button_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_status_edit_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_write_api_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_receipt_accept_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_reviewer_dispatch_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_runtime_execution_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_write_action_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_protected_action_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_final_approval_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_static_ui_production_pass_allowed_now: false,
    production_pass_enabled: false,
    enterprise_trust_claim_allowed_now: false,
...
function renderMarkdown(result) {
  return [
    "# Work OS Static Bundle Review UI Implementation Review Static UI Adapter",
    "",
    `Status: ${result.summary.work_os_static_bundle_review_ui_implementation_review_static_ui_status}`,
    `Program: ${result.program_range}`,
    `P40400 ready for static review UI: ${result.summary.source_p40400_ready_for_static_review_ui}`,
    ...
    `Ready for static review UI handoff: ${result.summary.ready_for_work_os_static_bundle_review_ui_implementation_review_static_ui_handoff}`,
    `Live mount allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_static_ui_live_mount_allowed_now}`,
    `Receipt accept allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_static_ui_receipt_accept_allowed_now}`,
...
<head>
  ...
  <title>Hermes Work OS Static Bundle Review UI Implementation Review Static UI Adapter</title>
  <style>
...
<body>
  <main>
    <h1>Hermes Work OS Static Bundle Review UI Implementation Review Static UI Adapter</h1>
...
async function readJsonOrBuildP40400(filePath, generatedAt) {
  const source = await readJsonSource(filePath);
  if (source.available) return source;
  const built = await buildWorkOsStaticBundleReviewUiImplementationReviewApiReadModel({ runAt: generatedAt, write: false });
  return normalizeInlineJsonSource("built.work_os_static_bundle_review_ui_implementation_review_api_read_model", built);
}
...
function normalizeInputs(options) {
  const defaults = DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_STATIC_UI_INPUTS;
  ...
  return {
    ...
    source_work_os_static_bundle_review_ui_implementation_review_api_read_model_path: path.resolve(repoRoot, options.sourceWorkOsStaticBundleReviewUiImplementationReviewApiReadModelPath ?? defaults.sourceWorkOsStaticBundleReviewUiImplementationReviewApiReadModelPath),
  };
}
...
function parseArgs(argv) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (arg === "--check") {
      ...
      args.sourceWorkOsStaticBundleReviewUiImplementationReviewApiReadModelPath = argv[++index];
...
function printHelp() {
  console.log(`Usage: node scripts/work-os-static-bundle-review-ui-implementation-review-static-ui-adapter.mjs [--check] [--out-dir DIR] [--source FILE] [--commit-ref SHA]

Validates or writes the Hermes P40401-P40800 Work OS Static Bundle Review UI Implementation Review Static UI Adapter.
`);
}
