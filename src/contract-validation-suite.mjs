...
const REQUIRED_PACKAGE_SCRIPTS = [
  ...
  "legal:citations",
  "law-firm:vdr-inventory",
  "law-firm:document-classification",
  "law-firm:extractor-selection",
  ...
  "personal-dev:plan-reconciliation",
  "personal-dev:scope-freeze",
  "personal-dev:dev-lanes",
  "personal-dev:patch-capture",
  "personal-dev:diff-review",
  "personal-dev:test-matrix",
  "personal-dev:protected-scan",
  "personal-dev:pr-draft",
  "personal-dev:release-note",
