...
function buildCloseoutGateRows({ closeoutRows, packageJson, platformOpsLedger, replayEvidenceChecklist }) {
  ...
  const rows = [
    ...
    gateRow("p356_next_phase_reserved", "P356-P360 remains reserved for reproducibility checks registered in validation and future release-check.", ledgerText.includes("P356-P360") && ledgerText.includes("reproducibility checks")),
  ];
