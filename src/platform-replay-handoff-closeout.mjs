...
function buildCloseoutGateRows({ closeoutRows, packageJson, platformOpsLedger, replayEvidenceChecklist }) {
  ...
  const rows = [
    ...
    gateRow("p356_next_phase_reserved", "P356-P360 own reproducibility registration, evidence, proof, operator review, and closeout.", ledgerText.includes("P356: `platform:reproducibility-check-registry`") && ledgerText.includes("P357: `platform:reproducibility-evidence-matrix`") && ledgerText.includes("P358: `platform:reproducibility-proof-index`") && ledgerText.includes("P359: `platform:reproducibility-operator-review`") && ledgerText.includes("P360: `platform:reproducibility-closeout`")),
  ];
