...
import {
  ALL_FALSE_FLAGS as P40000_FALSE_FLAGS,
  buildWorkOsStaticBundleReviewUiImplementationReviewPacketCandidate,
} from "./work-os-static-bundle-review-ui-implementation-review-packet-candidate.mjs";

export const DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_API_OUT_DIR = "artifacts/work-os-static-bundle-review-ui-implementation-review-api-read-model/latest";
export const DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_API_INPUTS = {
  schemaPath: "schemas/work-os-static-bundle-review-ui-implementation-review-api-read-model.schema.json",
  packagePath: "package.json",
  roadmapDocPath: "docs/hermes-roadmap-p40001-p40400.md",
  architectureDocPath: "docs/architecture.md",
  sourceWorkOsStaticBundleReviewUiImplementationReviewPacketCandidatePath: "artifacts/work-os-static-bundle-review-ui-implementation-review-packet-candidate/latest/work-os-static-bundle-review-ui-implementation-review-packet-candidate.json",
};

const COMMAND_NAME = "platform:work-os-static-bundle-review-ui-implementation-review-api-read-model";
const SCHEMA_VERSION = "work-os-static-bundle-review-ui-implementation-review-api-read-model.v1";
const CAPABILITY_ID = "platform.work_os_static_bundle_review_ui_implementation_review_api_read_model";
const PROGRAM_RANGE = "P40001-P40400";
const SOURCE_PROGRAM_RANGE = "P39601-P40000";
const READY_STATUS = "ready_for_work_os_static_bundle_review_ui_implementation_review_api_read_model";
const BLOCK_PENDING_STATUS = "valid_block_work_os_static_bundle_review_ui_implementation_review_api_read_model_pending";
const BLOCKED_STATUS = "blocked_work_os_static_bundle_review_ui_implementation_review_api_read_model";
...
export const WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_API_FALSE_FLAGS = [
  "work_os_static_bundle_review_ui_implementation_review_api_server_start_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_route_registration_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_runtime_route_execution_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_network_call_required_now",
  "work_os_static_bundle_review_ui_implementation_review_api_post_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_patch_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_put_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_delete_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_write_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_state_mutation_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_receipt_accept_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_receipt_create_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_reviewer_dispatch_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_claude_execution_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_human_adjudication_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_finding_resolution_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_review_completion_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_file_apply_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_file_write_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_generated_file_apply_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_build_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_browser_run_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_ui_mutation_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_fixture_persist_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_raw_payload_exposure_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_secret_read_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_approval_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_closeout_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_deployment_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_final_approval_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_production_pass_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_enterprise_trust_claim_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_human_gate_bypass_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_independent_review_bypass_allowed_now",
  "work_os_static_bundle_review_ui_implementation_review_api_final_automated_approval_allowed_now",
];
...
export async function runWorkOsStaticBundleReviewUiImplementationReviewApiReadModel(options = {}) {
  const result = await buildWorkOsStaticBundleReviewUiImplementationReviewApiReadModel(options);
  if (options.check && !result.validation.valid) {
    const error = new Error(`Work OS Static Bundle Review UI Implementation Review API Read Model failed with ${result.validation.errors.length} error(s).`);
    error.validation = result.validation;
    throw error;
  }
  if (!options.check && options.write !== false) await writeWorkOsStaticBundleReviewUiImplementationReviewApiReadModel(result, result.output_dir);
  return result;
}

export async function buildWorkOsStaticBundleReviewUiImplementationReviewApiReadModel(options = {}) {
  const generatedAt = new Date(options.runAt ?? new Date()).toISOString();
  const outputDir = path.resolve(options.outDir ?? DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_API_OUT_DIR);
  const inputs = normalizeInputs(options);
  const schema = await readJsonSource(inputs.schema_path);
  const packageJson = await readJsonSource(inputs.package_path);
  const roadmapDoc = await readTextSource(inputs.roadmap_doc_path);
  const architectureDoc = await readTextSource(inputs.architecture_doc_path);
  const source = Object.prototype.hasOwnProperty.call(options, "workOsStaticBundleReviewUiImplementationReviewPacketCandidate")
    ? normalizeInlineJsonSource("inline.work_os_static_bundle_review_ui_implementation_review_packet_candidate", options.workOsStaticBundleReviewUiImplementationReviewPacketCandidate)
    : await readJsonOrBuildP40000(inputs.source_work_os_static_bundle_review_ui_implementation_review_packet_candidate_path, generatedAt);
  ...
  const result = {
    ...
    inputs,
    source_refs: {
      work_os_static_bundle_review_ui_implementation_review_packet_candidate_path: source.path,
      source_commit_ref: commitRef || null,
    },
    source_work_os_static_bundle_review_ui_implementation_review_packet_candidate_summary: source.data?.summary ?? null,
    work_os_static_bundle_review_ui_implementation_review_api_contract: buildContract(generatedAt),
    work_os_static_bundle_review_ui_implementation_review_api_phase_rows: phaseRows,
    p40000_source_binding_rows: sourceRows,
    ...
    work_os_static_bundle_review_ui_implementation_review_api_wiring_rows: wiringRows,
    p40400_clean_checkpoint_rows: checkpointRows,
    work_os_static_bundle_review_ui_implementation_review_api_boundary: boundary,
    work_os_static_bundle_review_ui_implementation_review_api_validation_items: validationItems,
    validation: preliminaryValidation,
    summary: buildSummary({ boundary, validation: preliminaryValidation }),
  };

  const schemaErrors = schema.available
    ? validateAgainstSchema(result, schema.data, {}, "work_os_static_bundle_review_ui_implementation_review_api_read_model")
    : [{ path: "schema", message: schema.error ?? "Schema unavailable" }];
  const schemaValidationItems = schemaErrors.map((error, index) => validationItem(`schema.${index}`, "schema_validation", false, error.message));
  result.work_os_static_bundle_review_ui_implementation_review_api_validation_items = [...validationItems, ...schemaValidationItems];
  result.validation = summarizeValidation(result.work_os_static_bundle_review_ui_implementation_review_api_validation_items);
  result.summary = buildSummary({ boundary, validation: result.validation });
  return { ...result, markdown: renderMarkdown(result), html: renderHtml(result) };
}

export async function writeWorkOsStaticBundleReviewUiImplementationReviewApiReadModel(result, outDir = result.output_dir) {
  await mkdir(outDir, { recursive: true });
  await writeJson(path.join(outDir, "work-os-static-bundle-review-ui-implementation-review-api-read-model.json"), serializableResult(result));
  await writeJson(path.join(outDir, "p40000-source-binding-rows.json"), collectionEnvelope("p40000-source-binding-rows.v1", "p40000_source_binding_rows", result.p40000_source_binding_rows, result.generated_at));
  ...
  await writeJson(path.join(outDir, "work-os-static-bundle-review-ui-implementation-review-api-wiring-rows.json"), collectionEnvelope("work-os-static-bundle-review-ui-implementation-review-api-wiring-rows.v1", "work_os_static_bundle_review_ui_implementation_review_api_wiring_rows", result.work_os_static_bundle_review_ui_implementation_review_api_wiring_rows, result.generated_at));
  await writeJson(path.join(outDir, "p40400-clean-checkpoint-rows.json"), collectionEnvelope("p40400-clean-checkpoint-rows.v1", "p40400_clean_checkpoint_rows", result.p40400_clean_checkpoint_rows, result.generated_at));
  await writeJson(path.join(outDir, "work-os-static-bundle-review-ui-implementation-review-api-boundary.json"), result.work_os_static_bundle_review_ui_implementation_review_api_boundary);
  await writeFile(path.join(outDir, "summary.md"), result.markdown, "utf8");
  await writeFile(path.join(outDir, "index.html"), result.html, "utf8");
}

export async function runWorkOsStaticBundleReviewUiImplementationReviewApiReadModelCli(argv = process.argv.slice(2)) {
  const args = parseArgs(argv);
  if (args.help) {
    printHelp();
    return null;
  }
  const result = await runWorkOsStaticBundleReviewUiImplementationReviewApiReadModel(args);
  console.log(`Work OS Static Bundle Review UI Implementation Review API Read Model ${args.check ? "validated" : "written"} at ${result.output_dir}`);
  console.log(`Status: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_status}`);
  console.log(`Program: ${result.program_range}`);
  console.log(`P40000 ready for implementation review API: ${result.summary.source_p40000_ready_for_implementation_review_api}`);
  ...
  console.log(`Ready for implementation review API handoff: ${result.summary.ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff}`);
  console.log(`API write allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_write_allowed_now}`);
  console.log(`Review execution allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_claude_execution_allowed_now}`);
...
function buildSourceState(source) {
  ...
  return {
    ...
    p40000ContractReady: boundary.p40000_contract_ready === true,
    ...
    boundaryClosed: P40000_FALSE_FLAGS.every((flag) => boundary[flag] === false),
  };
}
...
function buildPhaseRows(roadmapText, generatedAt) {
  return PHASE_SPECS.map(([range, label, outputRef]) => row({
    ...
    evidence_ref: "docs/hermes-roadmap-p40001-p40400.md",
...
function buildSourceRows({ source, sourceState, commitRef, generatedAt }) {
  return [
    ["artifact_available", "P40000 implementation review packet candidate source is available", sourceState.available],
    ["program_range", "P40000 source program range is P39601-P40000", sourceState.programRangeOk],
    ["validation_valid", "P40000 source validation is valid", sourceState.validationValid],
    ["implementation_review_api_open", "P40000 opened implementation review API metadata", sourceState.sourceReady],
    ["p40000_contract_ready", "P40000 source contract is ready", sourceState.p40000ContractReady],
    ["packet_visible", "P40000 implementation review packet candidates are visible", sourceState.packetVisible],
    ["evidence_visible", "P40000 implementation review evidence summary rows are visible", sourceState.evidenceVisible],
    ["finding_visible", "P40000 implementation finding seed rows are visible", sourceState.findingVisible],
    ["reviewer_visible", "P40000 implementation reviewer lane request candidates are visible", sourceState.reviewerVisible],
    ["no_review_completion_closed", "P40000 no-review-completion boundary is closed", sourceState.noReviewCompletionClosed],
    ["review_wiring_visible", "P40000 review packet wiring is visible", sourceState.wiringVisible],
    ["commit_ref_present", "Current commit ref is present for implementation review API read model", Boolean(commitRef)],
    ["source_blocker_visible", "P40000 source blocker is visible when implementation review API handoff is closed", sourceState.available],
  ].map(([id, label, observed]) => row({
    row_id: `source_binding.${id}`,
    category: "p40000_source_binding",
    label,
    observed,
...
function buildNoMutationReviewExecutionBoundaryRows(generatedAt) {
  const stateRows = [
    ...
    label,
    observed,
    evidence_ref: "work_os_static_bundle_review_ui_implementation_review_api_boundary",
    generated_at: generatedAt,
  }));
...
function buildWiringRows({ packageJson, roadmapDoc, architectureDoc, generatedAt }) {
  return [
    ...
    ["validate_chain", "Validate chain includes P40400 check", packageJson.text.includes(`${COMMAND_NAME} -- --check`), "package.json"],
    ["schema_file", "Schema file is configured", packageJson.available, "schemas/work-os-static-bundle-review-ui-implementation-review-api-read-model.schema.json"],
    ["roadmap_doc", "Roadmap documents all P40001-P40400 slices", PHASE_SPECS.every(([range]) => roadmapDoc.text.includes(range)), "docs/hermes-roadmap-p40001-p40400.md"],
    ["architecture_doc", "Architecture doc references P40001-P40400", architectureDoc.text.includes("P40001-P40400 Work OS Static Bundle Review UI Implementation Review API Read Model"), "docs/architecture.md"],
  ].map(([id, label, observed, evidenceRef]) => row({
    row_id: `work_os_static_bundle_review_ui_implementation_review_api_wiring.${id}`,
    category: "work_os_static_bundle_review_ui_implementation_review_api_wiring",
    label,
    observed,
...
function buildCheckpointRows(context) {
  ...
  return [
    ["source_ready", "P40000 source is ready for implementation review API read model handoff", context.sourceState.sourceReady],
    ...
    ["p40400_api_handoff", "P40400 implementation review API handoff opens only as read-only metadata", ready],
  ].map(([id, label, observed]) => row({
    row_id: `p40400_checkpoint.${id}`,
    category: "p40400_clean_checkpoint",
    label,
    observed,
    evidence_ref: "p40400_clean_checkpoint_rows",
    generated_at: context.generatedAt,
  }));
}

function buildBoundary(context) {
  const p40400ContractReady = allPass(context.phaseRows)
    ...
    && allPass(context.boundaryRows)
    && allPass(context.wiringRows)
    && visibleOrPassed(context.checkpointRows, "p40400_checkpoint.api_write_blocked")
    && visibleOrPassed(context.checkpointRows, "p40400_checkpoint.receipt_accept_blocked")
    && visibleOrPassed(context.checkpointRows, "p40400_checkpoint.review_execution_blocked")
    && visibleOrPassed(context.checkpointRows, "p40400_checkpoint.raw_payload_secret_blocked")
    && visibleOrPassed(context.checkpointRows, "p40400_checkpoint.file_apply_blocked");
  const ready = context.sourceState.sourceReady
    && context.sourceState.validationValid
    && context.sourceState.boundaryClosed
    && p40400ContractReady;
  return {
    p40400_contract_ready: p40400ContractReady,
    ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff: ready,
    source_p40000_ready_for_implementation_review_api: context.sourceState.sourceReady,
    ...
    work_os_static_bundle_review_ui_implementation_review_api_wiring_complete_now: allPass(context.wiringRows),
...
function buildValidationItems(context) {
  return [
    validationItem("roadmap.phase_coverage", "roadmap", allPass(context.phaseRows), "P40001-P40400 phase rows are incomplete"),
    validationItem("source.visible", "source", visibleOrPassed(context.sourceRows, "source_binding.source_blocker_visible"), "P40000 source state is not visible"),
    ...
    validationItem("wiring.complete", "wiring", allPass(context.wiringRows), "P40001-P40400 wiring is incomplete"),
    ...
    validationItem("checkpoint.api_write_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p40400_checkpoint.api_write_blocked"), "P40400 API write blocker checkpoint is not visible"),
    validationItem("checkpoint.review_execution_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p40400_checkpoint.review_execution_blocked"), "P40400 review execution blocker checkpoint is not visible"),
    validationItem("checkpoint.raw_payload_secret_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p40400_checkpoint.raw_payload_secret_blocked"), "P40400 raw payload/secret blocker checkpoint is not visible"),
    validationItem("checkpoint.file_apply_blocked", "checkpoint", visibleOrPassed(context.checkpointRows, "p40400_checkpoint.file_apply_blocked"), "P40400 file apply blocker checkpoint is not visible"),
  ];
}

function buildContract(generatedAt) {
  return {
    contract_id: "work_os_static_bundle_review_ui_implementation_review_api_read_model.contract.v1",
    generated_at: generatedAt,
    source_p40000_required_or_rebuilt: true,
    ...
    p40400_is_not_api_server_route_registration_api_write_review_receipt_accept_reviewer_dispatch_claude_execution_finding_resolution_file_apply_approval_production_or_enterprise_trust: true,
    protected_authority: "closed",
  };
}

function buildSummary({ boundary, validation }) {
  const status = validation.valid && boundary.ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff
    ? READY_STATUS
    : validation.valid && boundary.p40400_contract_ready
      ? BLOCK_PENDING_STATUS
      : BLOCKED_STATUS;
  return {
    work_os_static_bundle_review_ui_implementation_review_api_status: status,
    source_p40000_ready_for_implementation_review_api: boundary.source_p40000_ready_for_implementation_review_api,
    ...
    ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff: validation.valid && boundary.ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff,
    work_os_static_bundle_review_ui_implementation_review_api_server_start_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_route_registration_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_runtime_route_execution_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_network_call_required_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_post_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_patch_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_put_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_delete_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_write_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_state_mutation_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_receipt_accept_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_receipt_create_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_reviewer_dispatch_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_claude_execution_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_human_adjudication_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_finding_resolution_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_review_completion_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_file_apply_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_file_write_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_generated_file_apply_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_build_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_browser_run_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_ui_mutation_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_raw_payload_exposure_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_secret_read_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_final_approval_allowed_now: false,
    work_os_static_bundle_review_ui_implementation_review_api_production_pass_allowed_now: false,
    production_pass_enabled: false,
    enterprise_trust_claim_allowed_now: false,
...
function renderMarkdown(result) {
  return [
    "# Work OS Static Bundle Review UI Implementation Review API Read Model",
    "",
    `Status: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_status}`,
    `Program: ${result.program_range}`,
    `P40000 ready for implementation review API: ${result.summary.source_p40000_ready_for_implementation_review_api}`,
    ...
    `Ready for implementation review API handoff: ${result.summary.ready_for_work_os_static_bundle_review_ui_implementation_review_api_handoff}`,
    `API write allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_write_allowed_now}`,
    `Review execution allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_claude_execution_allowed_now}`,
    `Raw payload exposure allowed: ${result.summary.work_os_static_bundle_review_ui_implementation_review_api_raw_payload_exposure_allowed_now}`,
...
<head>
  ...
  <title>Hermes Work OS Static Bundle Review UI Implementation Review API Read Model</title>
  <style>
...
<body>
  <main>
    <h1>Hermes Work OS Static Bundle Review UI Implementation Review API Read Model</h1>
...
async function readJsonOrBuildP40000(filePath, generatedAt) {
  const source = await readJsonSource(filePath);
  if (source.available) return source;
  const built = await buildWorkOsStaticBundleReviewUiImplementationReviewPacketCandidate({ runAt: generatedAt, write: false });
  return normalizeInlineJsonSource("built.work_os_static_bundle_review_ui_implementation_review_packet_candidate", built);
}
...
function normalizeInputs(options) {
  const defaults = DEFAULT_WORK_OS_STATIC_BUNDLE_REVIEW_UI_IMPLEMENTATION_REVIEW_API_INPUTS;
  ...
  return {
    ...
    source_work_os_static_bundle_review_ui_implementation_review_packet_candidate_path: path.resolve(repoRoot, options.sourceWorkOsStaticBundleReviewUiImplementationReviewPacketCandidatePath ?? defaults.sourceWorkOsStaticBundleReviewUiImplementationReviewPacketCandidatePath),
  };
}
...
function parseArgs(argv) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (arg === "--check") {
      ...
      args.sourceWorkOsStaticBundleReviewUiImplementationReviewPacketCandidatePath = argv[++index];
...
function printHelp() {
  console.log(`Usage: node scripts/work-os-static-bundle-review-ui-implementation-review-api-read-model.mjs [--check] [--out-dir DIR] [--source FILE] [--commit-ref SHA]

Validates or writes the Hermes P40001-P40400 Work OS Static Bundle Review UI Implementation Review API Read Model.
`);
}
