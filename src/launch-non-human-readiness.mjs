...
export async function buildLaunchNonHumanReadiness(options = {}) {
  ...
  const boundary = buildBoundary({ sources, sourceRows, humanExclusionRows, workstreamRows, commandRows, authorityRows, executionPlanRows, generatedAt });
  const validationItems = buildValidationItems({ packageJson, sourceRows, humanExclusionRows, workstreamRows, commandRows, authorityRows, executionPlanRows, boundary });
  ...
  const result = {
    ...
    summary: buildSummary({ sourceRows, humanExclusionRows, workstreamRows, commandRows, authorityRows, executionPlanRows, boundary, validation: preliminaryValidation }),
  };
  ...
  result.summary = buildSummary({ sourceRows, humanExclusionRows, workstreamRows, commandRows, authorityRows, executionPlanRows, boundary, validation: result.validation });
