...
P451 consumes P450 secret scan remediation receipt chain secret-leakage
...
- Source: P450 `trading:secret-scan-remediation-receipt-chain-secret-leakage-regression-fixtures`.
- Output: `artifacts/trading-secret-scan-remediation-receipt-chain-secret-scan-gate-fixtures/latest`.
- Workflow: `workflow.trading.secret_scan_remediation_receipt_chain_secret_scan_gate_fixtures.v1`.
- Capability: `trading.secret_scan_remediation_receipt_chain_secret_scan_gate_fixtures`.
...
```sh
npm run trading:secret-scan-remediation-receipt-chain-secret-scan-gate-fixtures -- --check
```
