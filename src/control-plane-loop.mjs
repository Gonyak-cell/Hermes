...
export const DEFAULT_CONTROL_PLANE_LOOP_STEPS = [
  ...
  step("dashboard_before_api_freeze", "Dashboard Before API Freeze", "dashboard", ["node", "scripts/review-dashboard.mjs", "--no-dashboard-api-freeze", "--no-threat-model-refresh", "--no-prompt-injection-test-suite", "--no-external-model-policy-audit", "--no-secrets-scan-gate", "--no-retention-deletion-policy", "--no-access-review-report", "--no-performance-cost-budget-report", "--no-backup-restore-drill", "--no-law-firm-e2e-report", "--no-personal-dev-e2e-report", "--no-creative-document-e2e-report", "--no-ingestion-e2e-report", "--no-deployment-runbook", "--no-operator-handbook", "--no-release-candidate-report", "--no-v1-freeze", "--no-control-plane-loop", "--no-control-plane-goal-checkpoint"], ["artifacts/dashboard/latest/review-dashboard.json"]),
  ...
  step("prompt_injection_test_suite", "Prompt Injection Test Suite", "security", ["npm", "run", "security:prompt-injection-tests"], ["artifacts/prompt-injection-test-suite/latest/prompt-injection-test-suite.json", "artifacts/prompt-injection-test-suite/latest/prompt-injection-test-fixtures.json", "artifacts/prompt-injection-test-suite/latest/prompt-injection-test-results.json", "artifacts/prompt-injection-test-suite/latest/prompt-injection-promotion-checks.json", "artifacts/prompt-injection-test-suite/latest/prompt-injection-test-boundary.json", "artifacts/prompt-injection-test-suite/latest/validation-report.json"]),
  step("external_model_policy_audit", "External Model Policy Audit", "security", ["npm", "run", "security:external-model-policy-audit"], ["artifacts/external-model-policy-audit/latest/external-model-policy-audit.json", "artifacts/external-model-policy-audit/latest/external-model-classification-audits.json", "artifacts/external-model-policy-audit/latest/external-model-policy-snapshot-audits.json", "artifacts/external-model-policy-audit/latest/external-model-route-audits.json", "artifacts/external-model-policy-audit/latest/desktop-provider-model-audits.json", "artifacts/external-model-policy-audit/latest/external-model-policy-audit-boundary.json", "artifacts/external-model-policy-audit/latest/validation-report.json"]),
  step("secrets_scan_gate", "Secrets Scan Gate", "security", ["npm", "run", "security:secrets-scan-gate"], ["artifacts/secrets-scan-gate/latest/secrets-scan-gate.json", "artifacts/secrets-scan-gate/latest/secrets-scan-source-statuses.json", "artifacts/secrets-scan-gate/latest/secrets-scan-rule-results.json", "artifacts/secrets-scan-gate/latest/secrets-scan-gate-results.json", "artifacts/secrets-scan-gate/latest/desktop-config-leakage-checks.json", "artifacts/secrets-scan-gate/latest/secrets-scan-boundary.json", "artifacts/secrets-scan-gate/latest/validation-report.json"]),
  step("retention_deletion_policy", "Retention Deletion Policy", "compliance", ["npm", "run", "compliance:retention-deletion-policy"], ["artifacts/retention-deletion-policy/latest/retention-deletion-policy.json", "artifacts/retention-deletion-policy/latest/retention-deletion-source-statuses.json", "artifacts/retention-deletion-policy/latest/retention-deletion-policy-rows.json", "artifacts/retention-deletion-policy/latest/deletion-hold-records.json", "artifacts/retention-deletion-policy/latest/retention-deletion-gate-results.json", "artifacts/retention-deletion-policy/latest/retention-deletion-boundary.json", "artifacts/retention-deletion-policy/latest/validation-report.json"]),
  step("access_review_report", "Access Review Report", "compliance", ["npm", "run", "compliance:access-review-report"], ["artifacts/access-review-report/latest/access-review-report.json", "artifacts/access-review-report/latest/access-review-source-statuses.json", "artifacts/access-review-report/latest/access-review-subjects.json", "artifacts/access-review-report/latest/access-review-matter-rows.json", "artifacts/access-review-report/latest/access-review-resource-rows.json", "artifacts/access-review-report/latest/access-review-findings.json", "artifacts/access-review-report/latest/access-review-gate-results.json", "artifacts/access-review-report/latest/access-review-boundary.json", "artifacts/access-review-report/latest/validation-report.json"]),
  step("performance_cost_budget_report", "Performance/Cost Budget Report", "compliance", ["npm", "run", "compliance:performance-cost-budget-report"], ["artifacts/performance-cost-budget/latest/performance-cost-budget-report.json", "artifacts/performance-cost-budget/latest/performance-cost-budget-sources.json", "artifacts/performance-cost-budget/latest/performance-budget-rows.json", "artifacts/performance-cost-budget/latest/cost-budget-rows.json", "artifacts/performance-cost-budget/latest/performance-cost-budget-gate-results.json", "artifacts/performance-cost-budget/latest/performance-cost-budget-boundary.json", "artifacts/performance-cost-budget/latest/validation-report.json"]),
  step("backup_restore_drill", "Backup/Restore Drill", "compliance", ["npm", "run", "compliance:backup-restore-drill"], ["artifacts/backup-restore-drill/latest/backup-restore-drill-report.json", "artifacts/backup-restore-drill/latest/backup-restore-sources.json", "artifacts/backup-restore-drill/latest/restore-drill-rows.json", "artifacts/backup-restore-drill/latest/backup-restore-source-of-truth-rows.json", "artifacts/backup-restore-drill/latest/backup-restore-gate-results.json", "artifacts/backup-restore-drill/latest/backup-restore-boundary.json", "artifacts/backup-restore-drill/latest/validation-report.json"]),
  step("law_firm_e2e_report", "Law Firm E2E Report", "law_firm", ["npm", "run", "law-firm:e2e-report"], ["artifacts/law-firm-e2e-report/latest/law-firm-e2e-report.json", "artifacts/law-firm-e2e-report/latest/law-firm-e2e-sources.json", "artifacts/law-firm-e2e-report/latest/law-firm-e2e-scenario-rows.json", "artifacts/law-firm-e2e-report/latest/law-firm-e2e-chain-stages.json", "artifacts/law-firm-e2e-report/latest/law-firm-e2e-gate-results.json", "artifacts/law-firm-e2e-report/latest/law-firm-e2e-report-boundary.json", "artifacts/law-firm-e2e-report/latest/validation-report.json"]),
  step("personal_dev_e2e_report", "Personal Dev E2E Report", "personal_dev", ["npm", "run", "personal-dev:e2e-report"], ["artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-report.json", "artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-sources.json", "artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-scenario-rows.json", "artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-chain-stages.json", "artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-gate-results.json", "artifacts/personal-dev-e2e-report/latest/personal-dev-e2e-report-boundary.json", "artifacts/personal-dev-e2e-report/latest/validation-report.json"]),
  step("creative_document_e2e_report", "Creative Document E2E Report", "creative_document", ["npm", "run", "creative-document:e2e-report"], ["artifacts/creative-document-e2e-report/latest/creative-document-e2e-report.json", "artifacts/creative-document-e2e-report/latest/creative-document-e2e-sources.json", "artifacts/creative-document-e2e-report/latest/creative-document-e2e-scenario-rows.json", "artifacts/creative-document-e2e-report/latest/creative-document-e2e-chain-stages.json", "artifacts/creative-document-e2e-report/latest/creative-document-e2e-gate-results.json", "artifacts/creative-document-e2e-report/latest/creative-document-e2e-report-boundary.json", "artifacts/creative-document-e2e-report/latest/validation-report.json"]),
  step("ingestion_e2e_report", "Ingestion E2E Report", "resource_evidence", ["npm", "run", "ingestion:e2e-report"], ["artifacts/ingestion-e2e-report/latest/ingestion-e2e-report.json", "artifacts/ingestion-e2e-report/latest/ingestion-e2e-sources.json", "artifacts/ingestion-e2e-report/latest/ingestion-e2e-scenario-rows.json", "artifacts/ingestion-e2e-report/latest/ingestion-e2e-chain-stages.json", "artifacts/ingestion-e2e-report/latest/ingestion-e2e-gate-results.json", "artifacts/ingestion-e2e-report/latest/ingestion-e2e-report-boundary.json", "artifacts/ingestion-e2e-report/latest/validation-report.json"]),
  step("deployment_runbook", "Deployment Runbook", "deployment", ["npm", "run", "deployment:runbook"], ["artifacts/deployment-runbook/latest/deployment-runbook.json", "artifacts/deployment-runbook/latest/deployment-runbook-sources.json", "artifacts/deployment-runbook/latest/deployment-environments.json", "artifacts/deployment-runbook/latest/deployment-commands.json", "artifacts/deployment-runbook/latest/deployment-checklists.json", "artifacts/deployment-runbook/latest/deployment-rollback-procedures.json", "artifacts/deployment-runbook/latest/deployment-gate-results.json", "artifacts/deployment-runbook/latest/deployment-runbook-boundary.json", "artifacts/deployment-runbook/latest/validation-report.json"]),
  step("operator_handbook", "Operator Handbook", "operator", ["npm", "run", "operator:handbook"], ["artifacts/operator-handbook/latest/operator-handbook.json", "artifacts/operator-handbook/latest/operator-handbook-sources.json", "artifacts/operator-handbook/latest/operator-surfaces.json", "artifacts/operator-handbook/latest/operator-workflows.json", "artifacts/operator-handbook/latest/operator-screens.json", "artifacts/operator-handbook/latest/operator-recovery-procedures.json", "artifacts/operator-handbook/latest/operator-gates.json", "artifacts/operator-handbook/latest/operator-handbook-boundary.json", "artifacts/operator-handbook/latest/validation-report.json"]),
  step("release_candidate_report", "Release Candidate Report", "release", ["npm", "run", "release:candidate"], ["artifacts/release-candidate-report/latest/release-candidate-report.json", "artifacts/release-candidate-report/latest/release-candidate-sources.json", "artifacts/release-candidate-report/latest/release-candidate-matrix.json", "artifacts/release-candidate-report/latest/release-candidate-commands.json", "artifacts/release-candidate-report/latest/release-candidate-gates.json", "artifacts/release-candidate-report/latest/release-candidate-boundary.json", "artifacts/release-candidate-report/latest/validation-report.json"]),
  step("v1_freeze", "Hermes Harness v1.0 Freeze", "release", ["npm", "run", "release:freeze"], ["artifacts/v1-freeze/latest/v1-freeze.json", "artifacts/v1-freeze/latest/v1-freeze-sources.json", "artifacts/v1-freeze/latest/v1-freeze-checklist.json", "artifacts/v1-freeze/latest/v1-freeze-gates.json", "artifacts/v1-freeze/latest/v1-freeze-boundary.json", "artifacts/v1-freeze/latest/validation-report.json"]),
...
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-prompt-injection-test-suite")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-prompt-injection-test-suite");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-external-model-policy-audit")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-external-model-policy-audit");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-secrets-scan-gate")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-secrets-scan-gate");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-retention-deletion-policy")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-retention-deletion-policy");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-access-review-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-access-review-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-performance-cost-budget-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-performance-cost-budget-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-backup-restore-drill")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-backup-restore-drill");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-law-firm-e2e-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-law-firm-e2e-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-personal-dev-e2e-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-personal-dev-e2e-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-creative-document-e2e-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-creative-document-e2e-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-ingestion-e2e-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-ingestion-e2e-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-deployment-runbook")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-deployment-runbook");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-operator-handbook")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-operator-handbook");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-release-candidate-report")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-release-candidate-report");
}
if (dashboardPreHealthStep && !dashboardPreHealthStep.command.includes("--no-v1-freeze")) {
  const insertIndex = dashboardPreHealthStep.command.indexOf("--no-gate-approval-contract-freeze");
  dashboardPreHealthStep.command.splice(insertIndex >= 0 ? insertIndex : dashboardPreHealthStep.command.length, 0, "--no-v1-freeze");
}
