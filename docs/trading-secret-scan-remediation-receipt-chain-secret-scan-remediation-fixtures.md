...
P454 consumes P453 secret-scan fail-closed readiness and records the operator
...
- Source: P453 `trading:secret-scan-remediation-receipt-chain-secret-scan-fail-closed-fixtures`.
...
- Output: `artifacts/trading-secret-scan-remediation-receipt-chain-secret-scan-remediation-fixtures/latest`.
- Workflow: `workflow.trading.secret_scan_remediation_receipt_chain_secret_scan_remediation_fixtures.v1`.
- Capability: `trading.secret_scan_remediation_receipt_chain_secret_scan_remediation_fixtures`.
...
```sh
npm run trading:secret-scan-remediation-receipt-chain-secret-scan-remediation-fixtures -- --check
```
