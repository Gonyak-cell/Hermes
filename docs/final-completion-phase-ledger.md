...
- 남은 planned slot은 P112-P312, 총 201개다.
...
| P111 | contract golden fixtures 구성 | golden fixture set | Promoted to Phase 111; 대표 contract artifact 14개가 schema validation과 regression hash manifest에 사용 |
